...
namespace GameDemo
{
    ...
    public:
        ...
        {
            static ::std::string __GameDemo__Hello_all[]=
            {
                "test",
                "testHello"
            };

            pair<string*, string*> r = equal_range(__GameDemo__Hello_all, __GameDemo__Hello_all+2, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __GameDemo__Hello_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
